  ...
  render() {
    ...
    return (
      <div className={classes.informationContent}>
        <h3>Nota de informare</h3>
        <h4>Privind prelucrarea datelor cu caracter personal</h4>
        ...
        <h4>1. Datele personale prelucrate</h4>
        <p>
        ...
        <h4>4. Transmiterea Datelor personale către terți</h4>
        <p>
        ...
        <h4>6. Securitate și confidențialitate</h4>
        <p>
        ...
        <h4>7. Contactează Code for Romania</h4>
        <p>
